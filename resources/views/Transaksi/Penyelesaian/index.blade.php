...
<form id="formSpj" class="form" action="{{ url('/realisasi/penyelesaian/' . $penugasan->id) }}" method="POST">
    @csrf
     <!-- Tabel Perencanaan, Penyelesaian, Penyelesaian -->
    <div class="nftmax__item  mg-top-40">
        <div class="row">
            <div class="col-12">
                <div class="nftmax__item-heading">
                    <h2 class="nftmax__item-title nftmax__item-title--psingle" style="font-size: 24px;">III. Penyelesaian</h2>
                    <h2 class="nftmax__item-title nftmax__item-title--psingle">1. Tujuan:</h2>
                    <span style="margin-left: 18px;">Membuat laporan hasil {{$penugasan->nama_kegiatan}} periode tahun {{$penugasan->tahun_anggaran}}</span>
                </div>
                    ...
                    <table class="table table-striped table-border radius mg-top-30">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $alokasi->penyelesaian*6.5 }}</td>
                                <td>
                                    @if($alokasi->role_id == 2)
                                        Penanggung Jawab
                                    @elseif($alokasi->role_id == 3)
