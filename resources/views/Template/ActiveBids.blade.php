												...
												<div class="dashboard-banner__main">
													...
													<div class="dashboard-banner__column dashboard-banner__column--one">
														...
														<div class="dashboard-banner__button">
															...
															<div class="dashboard-banner__single-btn">
																<a class="dashboard-banner__btn"><a href="{{url('/template/active-bids')}}" class="nftmax-btn nftmax-btn__secondary radius">Place a Bid</a></a>
															</div>
															<div class="dashboard-banner__single-btn">
																<a class="dashboard-banner__btn"><a href="{{url('/template/market-place')}}" class="nftmax-btn trs-white">View Atwork</a></a>
															</div>
														</div>
											...
											<div class="col-xxl-3 col-lg-3 col-md-6 col-12">
												...
												<div class="trending-action__single">
													...
													<div class="trending-action__body">
														...
														<h2 class="trending-action__title"><a href="{{url('/template/active-bids')}}">{{ $AllBids['3'] }}</a></h2>
													...
													<div class="dashboard-banner__button trending-action__bottom">
														...
														<a href="{{url('/template/market-place')}}" class="nftmax-btn trs-white">View Atwork</a>
													</div>
												</div>
