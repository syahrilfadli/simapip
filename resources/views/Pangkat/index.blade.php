                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="welcome-cta mg-top-40">
                            <div class="welcome-cta__heading">
                                <h2 class="welcome-cta__title">Daftar Pangkat</h2>
                                <p class="welcome-cta__text">Anda dapat menambahkan dan mengubah daftar Pangkat di
                                    module ini.</p>
                            </div>
                            <div class="welcome-cta__button">
                                <a href="{{ url('/pangkat/create') }}"
                                    class="nftmax-btn nftmax-btn__bordered bg radius">Tambah Pangkat</a>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row nftmax-gap-sq30">
                                        <div id="pangkat-container"></div>
                                        <div id="pangkat-pagination-container" class="pull-left"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                function loadPangkat() {
                    (function(containerId) {
                        ...
                        container.pagination({
                            dataSource: '/pangkat/list?search=' + encodeURIComponent($("#txt-search").val()) + '&ja=' +
                                ja,
                            locator: 'items',
                            ...
                            callback: function(response, pagination) {
                                ...
                                dataHtml += '<th class="nftmax-table__column-1 nftmax-table__h1">Nama Pangkat</th>';
                                dataHtml += '<th class="nftmax-table__column-2 nftmax-table__h2">Kode Golongan</th>';
                                dataHtml += '<th class="nftmax-table__column-2 nftmax-table__h2">Golongan</th>';
                                dataHtml += '<th class="nftmax-table__column-2 nftmax-table__h2">Urutan</th>';
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <form action="{{ url('pangkat/delete/${objData.id}') }}" method="POST">
                                                  @csrf
                                                  @method('DELETE')
                                ...
                                dataHtml += '</div>';
                                dataHtml += '</div>';                              
                                $("#pangkat-container #content").html(dataHtml);
                            }
                        })
                    })('#pangkat-pagination-container');
                }
            </script>
