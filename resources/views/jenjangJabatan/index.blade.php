    ...
    <div class="container">
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row nftmax-gap-sq30">
                                        <div id="jenjangJabatan-container"></div>
                                        <div id="jenjangJabatan-pagination-container" class="pull-left"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <script>
                ...
                function loadjenjangJabatan() {
                    (function(containerId) {
                        var container = $(containerId);
                        container.pagination({
                            dataSource: '/jenjangJabatan/list?search=' + encodeURIComponent($("#txt-search").val()) + '&ja=' +
                                ja,
                            locator: 'items',
                            ...
                            callback: function(response, pagination) {
                                ...
                                <tr>
                                    ...
                                    <td class="nftmax-table__column-1 nftmax-table__data-1">
										                  <div class="nftmax-table__amount nftmax-table__text-one">
											                  <span class="nftmax-table__text">${objData.level ?? "Not set"}</span>
									                    </div>
									                  </td>
