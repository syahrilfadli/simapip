                ...
                <div class="nftmax-sidebar__single">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show" id="side__two_BTC" role="tabpanel"
                            aria-labelledby="side__two">
                            <div class="nftmax-amount__statics">
                                <h4 class="nftmax-amount__statics__title">${{ $transectionRateBTCData['usd'] }} USD
                                </h4>
                                    ...
                                    @foreach ($TopCreators as $TopCreators)
                                        <li>
                                            <div class="nftmax-sidebar__creator">
                                                ...
                                                <a href="#"><b
                                                        class="nftmax-sidebar__creator-name">{{ $TopCreators['1'] }}<span
                                                            class="nftmax-sidebar__creator-link">{{ $TopCreators['2'] }}</span></b></a>
                                            </div>
                                    ...
                                    @foreach ($TopCreatorsWeekly as $TopCreatorsWeekly)
                                        <li>
                                            <div class="nftmax-sidebar__creator">
                                                ...
                                                <a href="#"><b
                                                        class="nftmax-sidebar__creator-name">{{ $TopCreatorsWeekly['1'] }}<span
                                                            class="nftmax-sidebar__creator-link">{{ $TopCreatorsWeekly['2'] }}</span></b></a>
                                            </div>
                                            <div class="nftmax-sidebar__button">
                                                <a href="#"
                                                    class="nftmax-sidebar__button-btn nftmax-request_request"><svg
                                    ...
                                    @foreach ($TopCreatorsMonthly as $TopCreatorsMonthly)
                                        <li>
                                            <div class="nftmax-sidebar__creator">
                                                ...
                                                <a href="#"><b
                                                        class="nftmax-sidebar__creator-name">{{ $TopCreatorsMonthly['1'] }}<span
                                                            class="nftmax-sidebar__creator-link">{{ $TopCreatorsMonthly['2'] }}</span></b></a>
                                            </div>
                                            <div class="nftmax-sidebar__button">
                                                <a href="#"
                                                    class="nftmax-sidebar__button-btn nftmax-request_request"><svg
