@extends('Layout.Template.LoginRegisterLayout')
...
<div class="col-xxl-6 col-lg-6 col-12">
							...
							<div class="nftmax-wc__form">
								<div class="nftmax-wc__form-inner">
									...
									@endif
									<!-- Sign in Form -->
									<form class="nftmax-wc__form-main" action="{{url('/template/admin-login')}}" method="POST">
                                        @csrf
										...
										<div class="form-group">
											<div class="nftmax-wc__bottom">
												<p class="nftmax-wc__text">Dont’t have an aceount ? <a href="{{url('/template/load-register')}}">Sign up free</a></p>
											</div>
										</div>
									</form>	
									<!-- End Sign in Form -->
