...
<div class="col-xxl-6 col-lg-6 offset-lg-0 col-md-10 offset-md-1 col-12">
							...
							<div class="nftmax-wc__form">
								<div class="nftmax-wc__form-inner nftmax-wc__form-new">
									...
									<!-- Sign in Form -->
									<form class="nftmax-wc__form-main" action="{{url('/template/register')}}" method="POST">
										@csrf
										<div class="row">
											...
											<div class="col-12">
												...
												<div class="form-group">
													<div class="nftmax-wc__bottom">
														<p class="nftmax-wc__text">Already have an aceount? <a href="{{url('/template/load-login')}}">Login</a></p>
													</div>
												</div>
											</div>
										</div>
