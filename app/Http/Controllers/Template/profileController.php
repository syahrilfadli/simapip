...
class profileController extends Controller
{
    public function index()
    {
        ...
        return view('Template.Profile',['User'=>$User,'Activity'=>$Activity,'collection'=>$collection,'OnSale'=>$OnSale,'Created'=>$Created,'CreateforBits'=>$CreateforBits,'CreateforSell'=>$CreateforSell,'Owned'=>$Owned,'CreateforBitsHidden'=>$CreateforBitsHidden,'CreateforSellHidden'=>$CreateforSellHidden]);
    }
}
