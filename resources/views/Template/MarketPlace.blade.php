															...
															<div class="col-lg-4 col-md-6 col-12">
																...
																<div class="trending-action__single trending-action__single--v2">
																	...
																	<div class="trending-action__body trending-marketplace__body">
																		<h2 class="trending-action__title"><a href="{{url('/template/market-place')}}">{{ $Explore['6'] }}</a></h2>
																		<div class="nftmax-currency">
																			...
																			<a href="{{url('/template/market-place')}}" class="nftmax-btn nftmax-btn__secondary radius">On Sale</a>
																		</div>
																	</div>
																</div>
														...
														@foreach($FeaturedArtist as $FeaturedArtist)
															<div class="col-lg-4 col-md-6 col-12">
																...
																<div class="trending-action__single trending-action__single--v2">
																	...
																	<!-- Trending Body -->
																	<div class="trending-action__body trending-marketplace__body">
																		<h2 class="trending-action__title"><a href="{{url('/template/market-place')}}">{{ $FeaturedArtist['6'] }}</a></h2>
																		<div class="nftmax-currency">
																			<div class="nftmax-currency__main">
																				<div class="nftmax-currency__icon"><img src="{{ asset($Explore['7']) }}" alt="#"></div>
																				<div class="nftmax-currency__content">
														...
														@foreach($PartnerShops as $PartnerShops)
															<div class="col-lg-4 col-md-6 col-12">
																...
																<div class="trending-action__single trending-action__single--v2">
																	...
																	<!-- Trending Body -->
																	<div class="trending-action__body trending-marketplace__body">
																		<h2 class="trending-action__title"><a href="{{url('/template/market-place')}}">{{ $PartnerShops['6'] }}</a></h2>
																		<div class="nftmax-currency">
																			<div class="nftmax-currency__main">
																				<div class="nftmax-currency__icon"><img src="{{ asset($Explore['7']) }}" alt="#"></div>
																				<div class="nftmax-currency__content">
