...
<form id="formSpj" class="form" action="{{ url('/realisasi/perencanaan/' . $penugasan->id) }}" method="POST">
    @csrf
        ...
        <div class="row">
            <div class="col-12">
                <div class="nftmax__item-heading">
                    <h2 class="nftmax__item-title nftmax__item-title--psingle" style="font-size: 24px;">I. Perencanaan</h2>
                    <h2 class="nftmax__item-title nftmax__item-title--psingle">1. Tujuan:</h2>
                    <span style="margin-left: 18px;">Mempersiapkan bahan kegiatan {{$penugasan->nama_kegiatan}} periode tahun {{$penugasan->tahun_anggaran}}</span>
                </div>
